...
class PlotDevice {
    ...
    getJudgement(model) {
        ...
        if (vp >= model.users[0].getGoal()) {
            View.addAlert("success", `LEVEL UP! <span class="noto">🚀</span><br>${Math.round(model.users[0].getVictoryPoints()/model.users[0].getGoal()*100-100)}% above goal <span class="noto">👑</span>`)
