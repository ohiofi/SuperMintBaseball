class Crest {
    ...
    constructor(colorScheme, teamPlaceAbbreviation) {
        this.id = Crest.crestCounter += Math.ceil(rng.random() * 2);
    ...
    generateShape() {
        //const randShape = Math.floor(rng.random() * 40);
        switch (this.id % 40) {
            case 0:
                // Hexagon
            ...
            case 23:
                // badge
                return "50,3 66,15 82,3 87,6 94,15 94,36 85,60 70,80 50,97 30,80 15,60 6,36 6,15 13,6 18,3 34,15"
            case 24:
                // shield
            ...
            case 37:
                // cool cross
                //return "49,33 70,5 70,33 95,33 95,66 49,66 30,95 30,66 5,66 5,33"
                //return "44,33 70,5 66,44 95,66 56,66 30,95 33,56 5,33"
                return "44,33 72,3 67,44 98,67 57,67 30,98 33,57 3,33"
            case 38:
                // bent babbet
    ...
    render(size = 25) {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
            ...
            <text 
                ...
                style="-webkit-text-stroke: ${0.005*size}px ${this.shadowColor}; text-shadow: ${0.0125*size}px ${0.0125*size}px 0px ${this.shadowColor}, -${0.005*size}px -${0.005*size}px 0px ${this.shadowColor}, -${0.005*size}px ${0.0075*size}px 0px ${this.shadowColor}, ${0.005*size}px -${0.005*size}px 0px ${this.shadowColor};"
        >
